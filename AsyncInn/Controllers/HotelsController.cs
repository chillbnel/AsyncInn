...
namespace AsyncInn.Controllers
{
    public class HotelsController : Controller
    {
        ...
        {
            return View(await _context.GetHotels());//refactored to now use HotelServices
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var hotel = await _context.GetHotel(id);//refactored to now use HotelServices
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Address,Phone")] Hotel hotel)
        {
            ...
            {
                await _context.CreateHotel(hotel);//refactored to now use HotelServices
        ...
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,Address,Phone")] Hotel hotel)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    await _context.UpdateHotel(hotel);//refactored to now use HotelServices
                }
